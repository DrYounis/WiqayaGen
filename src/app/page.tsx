...
import { Dna, BrainCircuit, ShieldCheck, Activity, TrendingUp, Lock } from 'lucide-react';
      ...
      <header className="relative pt-32 pb-20 px-6 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <button className="px-8 py-4 bg-white text-slate-700 border border-slate-200 rounded-xl hover:bg-slate-50 transition-all font-medium text-lg">
              تعرف على المزيد
            </button>
          </div>
        </div>
